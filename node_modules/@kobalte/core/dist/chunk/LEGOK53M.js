...
import { callHandler, mergeRefs, visuallyHiddenStyles, mergeDefaultProps, composeEventHandlers, createGenerateId, access } from '@kobalte/utils';
...
function NumberFieldRoot(props) {
  ...
  const [value, setValue] = createControllableSignal({
    ...
    onChange: (value2) => {
      local.onChange?.(typeof value2 === "number" ? numberFormatter().format(value2) : value2);
