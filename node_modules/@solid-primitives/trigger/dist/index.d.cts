 ...
 * dirtyAll()
 */
declare function createTriggerCache<T>(mapConstructor?: WeakMapConstructor | MapConstructor): [track: (key: T) => void, dirty: (key: T) => void, dirtyAll: () => void];

export { type Trigger, TriggerCache, createTrigger, createTriggerCache };
