...
import { FiSun, FiMoon, FiMonitor, FiCheck } from 'solid-icons/fi';
import { DropdownMenu } from '@radix-ui/react-dropdown-menu'; // Assuming Radix UI is installed
...
function Header(props: JSX.HTMLAttributes<HTMLDivElement>) {
  ...
  const [theme, setTheme] = createSignal('system'); // theme state (light, dark, system)
